...
const Navbar = () => {
  return (
    <header className="w-full sticky top-0 z-40 backdrop-blur-md px-2 sm:px-20 py-3">
      <div className="flex  items-center  justify-between   ">
        <div className="flex items-center justify-center  gap-2 ">
         ...
         <section className=" h-full flex gap-4 sm:gap-10 items-center justify-center">
          <Link to={"/login"} className="text-gray-500 sm:text-lg text-sm hover:text-black ease-in-out sm:mt-1 mt-2 duration-300">Contact Us</Link>
