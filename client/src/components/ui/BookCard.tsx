...
const BookCard = () => {
    return (
        <Card className="sm:w-[300px] min-w-[170px] p-2">
          <div className="sm:h-40 h-24  flex items-center justify-between">

            <img src="/book.png" className="sm:h-36 sm:w-full h-20 w-full" alt="" />
          </div>
          <CardContent className="flex flex-col px-1 sm:py-2 py-1 my-2" >
            <p className="text-green-500 px-1 text-center sm:text-sm text-[8px] block items-center justify-center bg-green-200/25 border-2 border-green-400 w-auto mx-auto rounded-md mb-2  ">Programing</p>
