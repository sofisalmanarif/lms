    ...
    <main className='container mx-auto'>
        ...
        <div className='sm:w-[60%] w-full relative'>
            <div className='sm:pr-20 pr-5 border-b-[1px] border-gray-300 sm:pb-10 pb-4 py-2 sm:mb-10 mb-6' >
                ...
                <h1 className='sm:text-4xl  text-2xl  font-semibold'>You Don't know js</h1>
                <div className="text-green-500 px-1 text-center  sm:text-sm text-[10px]  items-center justify-center bg-green-200/25 border-2 border-green-300  w-fit rounded-md mb-1  sm:mb-2 ">Programing</div>    
