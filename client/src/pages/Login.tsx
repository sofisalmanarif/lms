...
const Login = () => {
    ...
    const loginHandler = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            setErrors({});
            const validatedUser = await validationSchema.validate(user, {
                abortEarly: false,
            });
        ...
        <main className="w-full max-w-[1920px] mx-auto  h-screen  flex ">
            <section className="sm:w-[50%] w-full flex flex-col relative px-0 items-center justify-center ">
                <div className="flex flex-col  sm:w-[50%] w-full text-left items-center  gap-6">
                    <h2 className="text-4xl font-bold sm:-ml-[70px] -ml-[36px] ">
                        Welcome back
                    </h2>
                    <form
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <span
                                ...
                                className="absolute text-gray-500 cursor-pointer top-[30px] right-3"
                            >
                                {showPassword ? <EyeClosedIcon /> : <EyeIcon />}
                            </span>
                        </div>
                        <TypographySmall>
                            <Link className="text-blue-700 text-xs" to={"/"}>
                                Forgot Password
                            </Link>
                        </TypographySmall>
                        <Button
                    ...
                    <TypographyP className="text-sm sm:-ml-[116px] ">
